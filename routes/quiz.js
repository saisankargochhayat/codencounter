    ...
    if (err) res.send(err);
      ...
      var quiz = new Quiz({
        ...
        questions: [{
          ...
          ques: req.body.ques2,
          option1: req.body.option5,
          option2: req.body.option6,
          option3: req.body.option7,
          option4: req.body.option8,
          correct: req.body.correct2
        }, {
          ques: req.body.ques3,
          option1: req.body.option9,
          option2: req.body.option10,
          option3: req.body.option11,
          option4: req.body.option12,
          correct: req.body.correct3
        }, {
          ques: req.body.ques4,
          option1: req.body.option13,
          option2: req.body.option14,
          option3: req.body.option15,
          option4: req.body.option16,
          correct: req.body.correct4
        }, {
          ques: req.body.ques5,
          option1: req.body.option17,
          option2: req.body.option18,
          option3: req.body.option19,
          option4: req.body.option20,
          correct: req.body.correct5
        }]
      });
